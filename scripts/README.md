...
Scripts utilitários de desenvolvimento, build e operação — não fazem parte do código de produto.

## Escopo

🚧 A definir — nenhum código foi escrito ainda neste repositório.
...
🚧 Vazio — aguardando o primeiro código. Sem conteúdo até que a decisão de implementação correspondente exista.
