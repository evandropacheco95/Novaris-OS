...
Wrapper compartilhado sobre services/kernel/logging/, para uso consistente de log em todo o monorepo.
...
🚧 Estrutura criada (Missão ENG-0000). Nenhuma implementação de código ainda.
